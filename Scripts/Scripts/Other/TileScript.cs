...
public class TileScript : MonoBehaviour
{
    ...
    public void OnMouseOver()
    {
        ...
        if (!EventSystem.current.IsPointerOverGameObject() && GameManager.Instance.ClickedBtn != null)
        {
            ...
            if (IsEmpty)
            {
                ColorTile(emptyColor); //Set the mepty color (green color)
            }
     ...
     *   Place a tower test
     */
    public void PlaceTestTower()
    {
        //Creates the tower
        //GameObject tower = (GameObject)Instantiate(GameManager.Instance.ClickedBtn.TowerPrefab, transform.position, Quaternion.identity);

        GameObject tower =  GameManager.Instance.Pool.GetObject("TestTower");
        ...
        // add to the list
        GameManager.Instance.Towers.Add(myTower);

        // create reference to tower
        myTower.Tile = this;
