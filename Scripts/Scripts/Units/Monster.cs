...
public class Monster : Unit
{
    ...
    /// </summary>
    [SerializeField]
    private /*protected*/ Stat monsterHealth;
    
    /// <summary>
    /// The monster's element type
    /// </summary>
    [SerializeField]
    private /*protected*/ Element elementType;
   
    /// <summary>
    /// The monsters debuffs
    /// </summary>
    /*private*/protected List<Debuff> debuffs = new List<Debuff>();
    ...
    /// </summary>
    /*private*/protected int invulnerability = 2;
    ...
    public virtual void TakeDamage(float damage, Element dmgSource)
    {
    ...
    public virtual void Spawn(int health)
    {
        ...
        //LevelManager.Instance.GeneratePath(LevelManager.Instance.ra)
    ...
    protected new virtual void OnTriggerEnter2D(Collider2D other)
    {
        base.OnTriggerEnter2D(other);
        CollideRedPortal(other);
    ...
    // NIASSY WORK
    // ONLY FOR TEST
    // calleds when colliding with red portals
    public virtual void CollideRedPortal(Collider2D other)
    {
        if (other.name == "RedPortal")
        {
            //Animates the portal
